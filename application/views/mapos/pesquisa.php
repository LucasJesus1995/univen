            ...
            <div class="widget-content nopadding">
                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        <?php
                        if ($servicos == null) {
                            echo '<tr><td colspan="4">Nenhum ticket foi encontrado.</td></tr>';
                        }
                        foreach ($servicos as $r) {
                            ...
                            if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eServico')) {
                                echo '<a href="' . base_url() . 'index.php/servicos/editar/' . $r->idServicos . '" class="btn btn-info tip-top" title="Editar Ticket"><i class="icon-pencil icon-white"></i></a>';
                            }
            ...
            <div class="widget-content nopadding">
                ...
                <table class="table table-bordered ">
                    ...
                    <tbody>
                        <?php
                        if ($os == null) {
                            echo '<tr><td colspan="4">Nenhuma proposta foi encontrado.</td></tr>';
                        }
                        foreach ($os as $r) {
                            ...
                            if ($this->permission->checkPermission($this->session->userdata('permissao'), 'eOs')) {
                                echo '<a href="' . base_url() . 'index.php/os/editar/' . $r->idOs . '" class="btn btn-info tip-top" title="Editar Proposta"><i class="icon-pencil icon-white"></i></a>';
                            }
                            echo '</td>';
                            echo '</tr>';
                        }
