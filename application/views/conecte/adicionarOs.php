                                ...
                                <form action="<?php echo current_url(); ?>" method="post" id="formOs">
                                    ...
                                    <div class="span12" style="padding: 1%; margin-left: 0">
                                        ...
                                        <div class="span12">
                                            ...
                                            <textarea class="span12" name="descricaoProduto" id="descricaoProduto" cols="30" rows="5" placeholder="Descreva o produto que deseja incluir na proposta e os itens nele se desejar..."></textarea>
                                        </div>
                                    </div>
