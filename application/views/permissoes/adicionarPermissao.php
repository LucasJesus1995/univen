                        ...
                        <table class="table table-bordered">
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            <input name="vPedido" class="marcar" type="checkbox" checked="checked" value="1" />
                                            <span class="lbl"> Visualizar Pedido</span>
                                        </label>
                                    </td>
                                    <td>
                                        <label>
                                            <input name="aPedido" class="marcar" type="checkbox" value="1" />
                                    ...
                                    <td>
                                        <label>
                                            <input name="dPedido" class="marcar" type="checkbox" value="1" />
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label>
                                            ...
                                            <span class="lbl"> Excluir Prosposta</span>
                                        </label>
                                    </td>
