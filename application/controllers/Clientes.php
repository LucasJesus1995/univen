...
class Clientes extends CI_Controller
{
    ...
    function gerenciar()
    {
        ...
        if ($documento) {
            $where_array['documento'] = $documento;
        }
        ...
        $this->data['results'] = $this->clientes_model->get('clientes', 'idClientes,nomeCliente,documento,cnpj,telefone,email,rua,numero,bairro,cidade,estado,cep',  $where_array, $config['per_page'], $this->uri->segment(3));
    ...
    function adicionar()
    {
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            $dataNascimento = set_value('nascimento');
            ...
            $data = array(
                ...
                'documento' => set_value('documentocpf'),
                'cnpj' => set_value('documentocnpj'),
                'rg' => set_value('rg'),
                'razao' => set_value('razao'),
                'telefone' => set_value('telefone'),
                'email' => set_value('email'),
                'emailContato' => set_value('email'),
                ...
                'cep' => set_value('cep'),
                'telefoneC' => set_value('telefoneC'),
                'emailC' => set_value('emailC'),
                'telefoneF' => set_value('telefoneF'),
                'emailF' => set_value('emailF'),
    ...
    function editar()
    {
        ...
        if ($this->form_validation->run('clientes') == false) {
            ...
            $data = array(
                ...
                'documento' => $this->input->post('documentocpf'),
                'cnpj' => $this->input->post('documentocnpj'),
                ...
                'telefoneF' => $this->input->post('telefoneF'),
                'emailF' => $this->input->post('emailF')
            );
